...
HD_PWD='C:/Users/88696/Desktop/DIC/DlIC/HW10-2/CONV/CONV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_aux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv_aux.tcl
