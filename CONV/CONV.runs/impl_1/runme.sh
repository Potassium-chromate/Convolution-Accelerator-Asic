...
HD_PWD='C:/Users/88696/Desktop/DIC/DlIC/HW10-2/CONV/CONV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_aux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source conv_aux.tcl -notrace
